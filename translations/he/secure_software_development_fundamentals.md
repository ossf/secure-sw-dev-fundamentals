...
פרק זה מתאר כיצד לתכנן מערכת תוכנה כך שתהיה מאובטחת, תוך התמקדות בעקרונות אבטחה מרכזיים כגון הרשאות מינימליות, גישור מלא (mediation) ואימות קלט.

מטרות הלמידה:

1. נסביר מהם עקרונות תכנון מערכת מאובטחת ונספק דוגמאות לכמה עקרונות מרכזיים מקובלים.
...
### מהם עקרונות אבטחה בתכנון המערכת?
...
זכרו שתהליך התכנון, כמו כל תהליך פיתוח תוכנה אחר, אינו חד פעמי. זהו תרחיש נפוץ לנסות ליישם תוכנה, להבין כי התכנון לא עובד, ולאחר מכן לשנות את התכנון. לעתים קרובות יש לשנות תכנון כאשר משנים את מה שהתוכנה עושה. אז תהליך התכנון קורה בכל פעם שאתה חושב על שינוי בפירוק הבעיה שהתוכנה שלך פותרת.

תכנונים מסוימים טובים יותר מאחרים: חלקם קלים יותר לתחזוקה, מהירים יותר וכן הלאה. בפרט, תכנונים מסוימים מאובטחים יותר מאחרים. אין פתרון קסם שמבטיח שהתכנון שלכם מאובטח. אבל מניסיונם של אנשים המפתחים תוכנה במשך עשרות שנים, זוהו סט של *עקרונות תכנון* שיכולים לעזור לך לבחור תכנונים טובים על פני רעים.


עקרונות תכנון המערכת הם מדריכים מדויקים המבוססים על ניסיון ופרקטיקה. במילים אחרות, עקרונות התכנון הם כללי אצבע שיעזרו לכם להימנע מבעוד מועד מתכנון גרוע וינחו אתכם לתכנון טוב במקום זאת. עם זאת, עקרונות תכנון מאובטח אינם מבטיחים אבטחה; הם כלי עזר לחשיבה, לא תחליף לחשיבה. לדוגמה, לפעמים עיקרון לא יחול בכלל. לפעמים עקרונות מתנגשים; לדוגמה, עיקרון אחד של תכנון מאובטח הוא שמירה על פשטות, אבל לפעמים נדרשת יותר מורכבות כדי לבצע משהו מסויים. במקרים נדירים יותר, יכולות להיות סיבות טובות מבחינה אבטחה שמפרות לחלוטין עיקרון. עם זאת, התוכנה שלך תהיה בדרך כלל מאובטחת יותר על ידי התחשבות בעקרונות תכנון מאובטחים וניסיון ליישם אותם. עקרונות תכנון מאובטחים הם חוכמה מזוקקת, וכדאי לשקול אותם.


כשחושבים על התכנון, צריך לחשוב על אילו רכיבים ניתן לסמוך (וכמה), ועל אילו רכיבים לא בהכרח ניתן לסמוך. כמה עקרונות תכנון מדברים על *גבול אמון*. גבול האמון הוא פשוט הגבול בין הרכיבים שניתן לסמוך עליהם לבין הרכיבים שלא בהכרח ניתן לסמוך עליהם. מיקום גבול האמון תלוי בתוכנה הממפותחת:


* כשכותבים יישום בצד השרת, סביר להניח שנותנים אמון במה שמריץ את היישום (לדוגמה, המחשב, מערכת ההפעלה וזמן הריצה של הקונטיינר , אם קיים), אך לא במערכות החיצוניות בצד הלקוח (שחלקן עשויות להיות נשלטות על-ידי תוקף). גבול האמון הוא בין השרת ללקוחות.


* אם כותבים אפליקציה סלולרית (לטלפון חכם) שמדברת עם השרת שבשליטתנו, סביר להניח שסומכים על השרת המרוחק הזה. לא צריך לסמוך על נתיב התקשורת בין היישום שלנו לשרת (אז נירצה להשתמש בTLS כדי להצפין אותו). בהחלט לא צריך לסמוך על יישומים אחרים בטלפון החכם, אלא אם כן יש סיבה מיוחדת לסמוך עליהם. אז ברור שיש גבול בין היישום שלנו לבין (1) האינטרנט ו-(2) יישומים ניידים אחרים. אמון הוא לעתים קרובות לא מוחלט; אנחנו כנראה סומכים על כך שמערכת ההפעלה של הטלפון החכם תפעל עבור אותו משתמש, אך משתמש זה עשוי להיות תוקף, אז כנראה צריך לוודא שהרשאות גישה (סיקרטס/ secrets) מסוימים לעולם לא יגיעו ליישום הנייד בכלל.


#### חידון 2.1: מהם עקרונות תכנון מערכת מאובטחת?

\>\>אם עוקבים אחר עקרונות התכנון של מערכת מאובטחת, תמיד נוצרת תוכנה מאובטחת. אמת או שקר?<<
...
למרבה הצער, שמירה על עקרונות תכנון של מערכת מאובטחת אינה מבטיחה תוכנה מאובטחת. במקום זאת, הם רק מדריך בעל ערך לדרך זו. עדיין צריך *לחשוב*.


[הסבר]

### עקרונות תכנון מערכת מאובטחת מומלצים

תוכנה נמצאת תחת מתקפה כבר עשרות שנים, ועקרונות תכנון מערכת מאובטחת מרכזיים רבים זוהו בשנת 1975 על ידי ג'רום ה. זלצר ומייקל ד. שרודר (S&S) במאמרם, [*ההגנה על מידע במערכות מחשב*](http://web.mit.edu/Saltzer/www/publications/protection/index.html). מה שיפה ברשימה שלהם הוא שהיא עמדה במבחן הזמן; עקרונות אלה חשובים לא פחות כיום. עקרונות אחרים זוהו מאז, אבל בואו נתחיל עם הרשימה שלהם.

ברשימה שלהם הם מתמקדים *במערכת ההגנה* - כלומר, החלק של המערכת שהאבטחה תלויה בו. הנה הרשימה שלהם, יחד עם כמה שמות נרדפים:

1. **הרשאות פחותות (Least privilege)**<br> כל משתמש (אנושי) ותוכנה צריכים לפעול תוך שימוש במספר ההרשאות הנמוך ביותר האפשרי. עיקרון זה מגביל את הנזק כתוצאה מטעות או התקפה. הוא גם מפחית את מספר האינטראקציות הפוטנציאליות בין תוכניות מורשות, כך שסביר להניח ששימושים לא מכוונים, לא רצויים או לא ראויים בהרשאות יתרחשו פחות.


2. **גישור הרשאות מלא (גם אי-עקיפה) (Complete mediation)**<br>כל ניסיון גישה חייב להיבדק; יש למקם את המנגנון כך שלא ניתן יהיה לערער עליו. מילה נרדפת למטרה זו היא אי-עקיפה.


3. **מנגנון חסכוני (גם פשטות)**<br>המערכת, ובמיוחד החלק שהאבטחה תלויה בו, צריכה להיות פשוטה וקטנה ככל האפשר.

4. **תכנון פתוח**<br>אסור שמנגנון ההגנה יהיה תלוי בידע התוקף. במקום זאת, עליך לפעול כאילו המנגנון ידוע לציבור, ולהסתמך על סודיות של פריטים מעטים יחסית הניתנים לשינוי בקלות כמו סיסמאות או מפתחות פרטיים. תוקף לא אמור להיות מסוגל לפרוץ למערכת רק בגלל שאינו יודע איך היא עובדת. עקרון "אבטחה באמצעות אלמוניות" בדרך כלל לא עובד.


5. **ברירות מחדל מאובטחות**<br>התקנת ברירת המחדל צריכה להיות ההתקנה המאובטחת. אם לא בטוח שצריך לאפשר משהו, אל תאפשרו אותו.


6. **הפרדת הרשאות (לדוגמה, שימוש באימות דו-גורמי)**<br>הגישה לאובייקטים צריכה להיות תלויה ביותר מתנאי אחד (כגון סיסמה). כך, אם תוקף מצליח לשבור תנאי אחד (למשל, על ידי גניבת מפתח) המערכת נשארת מאובטחת. הערה: לפעמים תוכניות מחולקות לחלקים, כל חלק עם הרשאה אחרת. גישה זו נקראת לעתים באופן מבלבל "הפרדת הרשאות" - אך שבירת תוכנית לחלקים בעלי הרשאות שונות היא משהו אחר. בטרמינולוגיה זו, זוהי דוגמה להרשאה מינימלית.

7. **המנגנון הכי פחות נפוץ (גם למזער שיתוף)**<br> יש למזער את הכמות והשימוש במנגנונים משותפים. הימנע משיתוף קבצים, ספריות, שימוש בקרנל (kernel) של מערכת ההפעלה או מחשבים עם משהו שלא ניתן לבטוח בו, מכיוון שהתוקפים עלולים לנצל אותם.


8. **קבילות פסיכולוגית (גם קלות לשימוש)**<br>הממשק האנושי חייב להיות מתוכנן לשימוש קל כך שהמשתמשים ישתמשו באופן שגרתי ואוטומטי במנגנוני ההגנה בצורה נכונה.

מאז, זוהו גם עקרונות תכנון מאובטחים אחרים על ידי אנשים שונים; נסקור כמה כאלה במהלך הקורס.

זכרו, עקרונות התכנון הם פשוט כללי אצבע. כאשר אנו מפרקים את הבעיה כדי לפתור אותה, עלינו לחשוב על עקרונות אלה, מכיוון שהם יעזרו להנחות אותנו ליצירת תוכנה מאובטחת יותר. ישנם מקרים שבהם יהיו לנו סיבות טובות *לא* ליישם אותם. עקרונות אלה אינם מחליפים את החשיבה - הם עוזרים *להנחות* אותנו כאשר אנו חושבים.


לאחר מכן, נבחן ביתר פירוט כמה מהעקרונות הללו, משום שיש להם השלכות שאולי אינן ברורות מאליהן. ביחידה הבאה נתחיל בכך שנסתכל על *הרשאות פחותות*.

#### חידון 2.2: עקרונות תכנון מערכת מאובטחת מומלצים
...
עקרון "התכנון הפתוח" אומר שאנחנו לא יכולים לסמוך על כך שהתוקפים אינם יודעים איך מערכת עובדת. במקום זאת, עלינו לתכנן את המערכות שלנו כך שיישארו מאובטחות גם כאשר התוקף יודע בדיוק איך הן עובדות.


[הסבר]

### הרשאות פחותות (Least Privilege)


כבר ציינו כי עיקרון ההרשאות הפחותות הוא חשוב בתכנון מאובטח. הרעיון הבסיסי הוא שכל משתמש (אדם או תוכנית) צריך לפעול תוך שימוש בהרשאות המעטות ביותר האפשריות. באופן כללי, לא נאפשר קריאה או כתיבה של מידע אלא אם כן עלינו לעשות זאת עבור משתמש זה.


ההרשאה הפחותה ביותר מגבילה את הנזק הפוטנציאלי כתוצאה מהתקיפה, וגם מפחיתה את המורכבות של אינטראקציות הקשורות לאבטחה. זה אפילו משתרע על החלקים הפנימיים של תוכנית: רק החלק הקטן ביותר של תוכנית שזקוק להרשאות צריך (באופן אידיאלי) לקבל אותן. כמובן, בשלב מסוים, זה הופך להיות מסובך מדי (ואנחנו גם רוצים לשמור על התוכנית פשוטה ככל האפשר).

#### דרכים ליישם את ההרשאה הפחותה

להלן מספר דרכים ליישם את ההרשאה הפחותה, בהתאם לנסיבות:

1. **לא ניתן לתוכנית הרשאות מיוחדות (כאשר זה מעשי)**<br>אם ניתן לעשות זאת, נעשה זאת, מכיוון שזה הטוב ביותר מנקודת מבט של אבטחה. לדוגמה, לינוקס תומכת בהפיכת תוכניות **setuid** או **setgid**, כך שעצם הפעלת התוכנית מעניקה לתוכנית את ההרשאות של בעליה. אם אנו יכולים להימנע לחלוטין משימוש במנגנון זה, נשקול לעשות את זה, מכיוון שזה נותן הרשאות מיוחדות לתוכניות. לעתים קרובות יש חלופות בטוחות יותר; לדוגמה, דרישה מאנשים להתחבר באופן ספציפי עם הרשאות (זוהי המטרה של **SUDO**).


2. **נמזער את ההרשאות המיוחדות שתוכנית מקבלת, כולל מזעור כל הנתונים הנגישים לה**<br>בלינוקס, ייתכן שיש לנו תוכנית עבור (או בשם) קבוצה מיוחדת או משתמש שיש להם רק הרשאות ספציפיות, במקום משהו חסוי יותר (כמו root). אם אנו קוראים לממשק שאילתה של מערכת מסד נתונים, נגביל את הההרשאות של משתמש מסד הנתונים שבו משתמש היישום. אם מערכת מסד הנתונים שלנו משתמשת ב- SQL, ייתכן שנוכל להשתמש בפקודה SQL GRANT כדי להגביל את ההרשאות שהתוכנית מקבלת. משתמשי Redis עשויים להשתמש בפקודת ACL של Redis כדי להגביל הרשאות.


3. **ויתור לצמיתות על הרשאות בהקדם האפשרי**<br>  לדוגמה, אם משתמשים במזהי קבוצה שמורים של Linux (Group IDs), מזהי משתמשים (User IDs) או ביכולות שלהם, נשחרר לצמיתות הרשאות נוספות אלה בהקדם האפשרי. בדרך זו, אם ההתקפה מתרחשת לאחר מכן, התוקפים אינם יכולים לנצל הרשאות אלה.


4. **אם אין באפשרותנו לוותר לצמיתות על הרשאות, ננסה למזער את הזמן שבו ההרשאה פעילה**<br>פעולה זו פחות יעילה, מכיוון שהתקפות מסוימות עלולות לאלץ תוכניות להפעיל קוד שרירותי. אך התקפות מסוימות יכולות לגרום לתוכניות לבצע רק מספר מוגבל של פעולות, ומזעור הזמן שבו ההרשאה פעילה יפחית את מה שהתוקפים יכולים לעשות.

5. **נחלק את התוכנית למודולים שונים, וניתן הרשאות מיוחדות רק למודול אחד או לכמה מודולים (חלקים מהתוכנית)**  <br>המודול המורשה באופן אידיאלי אפילו לא ייתן אמון מלא בחלקים האחרים של התוכנית שלנו (גם *תכנון חשוד*). אם נעשה זאת, כאשר חלק כלשהו מהתוכנית שלנו יהיה תחת התקפה, זה יגביל את מה שתוקפים יכולים לעשות באופן מיידי. לדוגמה, ייתכן שנפצל את החלק של תוכנית המיישם ממשק משתמש גרפי מחלק אחר בעל הרשאות. מנגנוני הפרדה כמו קונטיינרים, מכונות וירטואליות, seccomp בלינוקס וסוגים שונים של מעטפות אבטחה יכולים לעזור לנו להפריד חלקים של התוכנית, כך שפגיעה בחלק אחד לא בהכרח תשבור אחר. ***היזהרו:*** *נקפיד להגדיר מנגנונים אלה כדי להפריד באופן מאובטח את המודולים, ולהגביל את ההרשאות בכל חלק.* מנגנוני הפרדה אלה לרוב אינם חסינים בפני תקלות, לכן אל תניחו שהשימוש בהם הופך את התוכנה למאובטחת באופן אוטומטי. עם זאת, הם יכולים להפוך את התוכנה שלנו לקשה יותר לתקיפה ועשויים להפחית את הנזק אם התקפה מצליחה.


6. **נמזער (נגביל) את שטח התקיפה** <br>*שטח התקיפה* הוא מערך הפעולות (לדוגמה, ה- API שלו ויציאות הרשת הפתוחות שלו) שתוקפים פוטנציאלים יכולים לגשת אליהן. לדוגמה, אם אנו מאפשרים גישה ציבורית למתודה כלשהי, אז אנו נותנים לכל התוקפים גישה למתודה זו - האם אנו בטוחים שאנו צריכים גישה זו? במידת האפשר, נגביל את הפעולות שתוקפים פוטנציאלים יכולים לגשת אליהן. אם לא צריך גישה ציבורית (public), לא נספק גישה ציבורית. בפרט, נמנע מהשארת פעולות דיבאג (debug) במערכות פרודקשן שהתוקפים יכולים לגשת אליהן; פעולות דיבאג הן מקור נפוץ לבעיות.


7. **נאמת (נבדוק) קלט לפני קבלתו**<br> לא נסתפק בקבלת נתונים מתוקפים פוטנציאלים; נבדוק אותו ביסודיות לפני שנקבל אותו. נדון באימות קלט ביתר פירוט בהמשך. כמובן, עלינו לוודא שהתוקפים אינם יכולים לעקוף אימות קלט זה; זו סוגיה כל כך גדולה שיש לה עיקרון משלה, *גישור מלא* (complete mediation), כלומר *אי-עקיפה* (non-bypassability). אנחנו נדבר עליה בהמשך.


8. **סאנדבוקס (Sandbox) של התוכנית שלנו**<br>נפעיל בכוונה את התוכנית (או חלק ממנה) בסביבה עם יכולות מוגבלות במכוון.


9. **נמזער הרשאות עבור קבצים ומשאבים אחרים**<br>לדוגמה, בדרך כלל אנו לא צריכים קבצים לכתיבה על ידי כולם (אפילו קריאה על ידי כולם היא לעתים קרובות לא נדרשת). באנדרואיד, קובץ הניתן לכתיבה על ידי כולם יכול להשתנות על ידי יישום אחר (אולי זדוני).

<br>

 הרשאות שגויות הן סיבה נפוצה כל כך לפגיעויות אבטחה שהן מדרגות במקום ה 22 ב- 25 הגדולות ב 2022 CWE  ובמקום ה 15 ב- 25 הגדולות ב CWE 2019. זהו         [CWE-732](https://cwe.mitre.org/data/definitions/732.html) (*הקצאת הרשאה שגויה עבור משאב קריטי*). הרשאות שגויות גרועות במיוחד אם  הרשאות *ברירת המחדל* אינן מאובטחות; המקרה המיוחד הוא [CWE-276](https://cwe.mitre.org/data/definitions/276.html) (*הרשאות ברירת מחדל שגויות*).


#### דוגמאות להרשאות פחותות

בואו נסתכל על כמה דוגמאות ספציפיות.

בעת פיתוח יישומים מבוססי אינטרנט, לא נאפשר למשתמשים לגשת (לקרוא) לקבצים כגון  קבצי **ה include והקונפיגורציה** של השרת. נתונים אלה עשויים לספק בטעות מספיק מידע (למשל, סיסמאות) כדי לפרוץ למערכת. אם משתמשים בשרת אינטרנט מסורתי, נשמור את כל מה שאיננו צריכים כדי לשרת ישירות משתמשים מחוץ ל"שורש התיעוד" (**DOCROOT);** בדרך זו, התוקפים אינם יכולים אפילו לבקש את המידע בקלות. נמנע הנגשה של קבצים שידוע לנו שאין להנגיש ישירות (כגון קבצי **include**).


לא נאפשר למשתמשים לכתוב קבצי תצורת מערכת (קונפיגורציה) כברירת מחדל (לדוגמה, קבצי מערכת ב- **etc/** בלינוקס וביוניקס), ובמידת האפשר, נשקול למנוע קריאות גם על ידי משתמשים רגילים. הבעיה היא שמנהלי מערכת מכניסים לעתים קרובות סיסמאות ומפתחות לקבצי תצורה. אם יש סיבות להעניק הרשאות קריאה רחבות יותר לחלק מהמידע על תצורת המערכת (לדוגמה,  ב- **etc/**), נשקול ליצור ספריית תצורת מערכת במקום קובץ תצורת מערכת שבו שם הספריה מסתיים באופן קונבנציונלי ב- **.d**. ספריות תצורת מערכת הן לעתים קרובות טובות יותר בכל מקרה, מכיוון שהן הופכות את השימוש לטריוויאלי עבור מנהלי חבילות להוסיף ולהסיר קבצי תצורה ספציפיים. מבחינת אבטחה, ספריות תצורת מערכת לא רק מפחיתות את הסיכון לשגיאות, אלא שלקבצים ספציפיים (כגון קבצים עם מפתחות סודיים וסיסמאות) יכולות להיות הרשאות מוגבלות יותר. אם אנו משתמשים בספריית תצורת מערכת, זה פחות בעייתי לאפשר למשתמש לקרוא, כי זה הרבה יותר קל להגן על המפתחות הסודיים וסיסמאות.


אם אנו מיישמים API חיצוני (לדוגמה, עם REST או GraphQL), לא נספק פעולת "כתיבה" אלא אם כן אנו מצפים שייעשה בה שימוש. אם אנו מאפשרים כתיבה, ננסה להגביל באופן מקסימלי *את מי* שכותב. לדוגמה, אפשרו רק לבעלים של נתונים ספציפיים לשנות נתונים אלה, במקום לאפשר לכל אחד לשנות דבר מה. אם זה מעשי, נתכנן את התוכנה כך שהיא לא תוכל לכתוב נתונים *גם* אם הם עורערו על ידי תוקף (אם כי לעתים קרובות זה לא מעשי).


למרבה הצער, מקובל לנהל הרשאות בצורה לא נכונה. לדוגמה, ישנם מקרים רבים שבהם תוכניות לא הצליחו לשחרר הרשאות בכל המקרים (למשל, משום שהעלאת או זריקת אקספשן (Exception) דילגה על הקוד שהשמיט הרשאות, או משום שהקוד שהיה אמור לשחרר הרשאות אינו פועל בכל המקרים).

 
 ניהול הרשאות לא תקין הוא גורם כה נפוץ לפגיעויות אבטחה עד כי הוא דורג במקום ה 29 ב- 25 הגדולות ב 2021 CWE  ובמקום ה 24 ב- 25 הגדולות ב CWE 2019. זהו         [CWE-269](https://cwe.mitre.org/data/definitions/732.html) (*ניהול הרשאות לא תקין*).

#### חידון 2.3: הרשאות פחותות

\>\>אחת הדרכים *שבהן ייתכן* שתוכלו ליישם חלק מהרשאות "ההרשאה הפחותה" (בהתאם לתוכנית) היא להשתמש בהצהרות SQL GRANT כך שלתוכנית לא יהיו זכויות לשנות נתונים מסוימים גם אם תוקפים ישתלטו על תוכנית זו. אמת או שקר?<<

(!) לא נכון.

(x) נכון.

### גישור הרשאות מלא (אי עקיפה)

בכל פעם שתוכנית מקבלת בקשה, לפחות ממקור שהתוכנית אינה יכולה לתת בו אמון מלא (הוא נמצא מחוץ לגבולות האמון), התוכנית חייבת לבדוק את הבקשה. דוגמאות לבדיקות אבטחה הן בדיקה שהבקשה מאושרת ושהקלט תקף לפני שאנו פועלים על סמך נתונים אלה. עיקרון זה נקרא גם *אי-עקיפה*, משום שהנקודה היא שאסור לתוקפים לעקוף בדיקות אבטחה.


טעות נפוצה היא לנסות להפעיל בדיקות אבטחה במערכת שהתוקפים יכולים לשלוט בה. אם תוקפים יכולים לשלוט במערכת, התוקפים יכולים לעקוף בקלות את כל בדיקות האבטחה המופעלות על-ידי אותה מערכת. בואו נסתכל על כמה דוגמאות של  תכנוני מערכת *לא מאובטחים*.

#### תכנון מערכת לא מאובטח: אימות קלט HTML בצד הלקוח

דוגמה פשוטה לתכנון לא מאובטח היא כאשר יישום אינטרנט בצד השרת שולח HTML מסוים ללקוח, ו- HTML כולל דרישת אימות מסוימת. לדוגמה, HTML עשוי לכלול את המשפט הבא כדי לדרוש שהאורך המרבי לא יעלה על 100:

~~~~html
    <input id="name" type="text" maxlength="100">
~~~~

  זה בסדר אם מטרתו היא להיות בדיקה מהירה כדי להתמודד עם טעויות מקריות. אבל מכיוון שהתוקפים יכולים לשלוט בדפדפן האינטרנט שלהם, בדיקת אורך מקסימלית זו היא טריוויאלית לעקיפה. תוקפים יכולים לשלוח בקלות קלט ארוך בהרבה. לא ניתן *לסמוך* על דפדפן האינטרנט שיבצע עבורך בדיקה רלוונטית לאבטחה אם התוקפים יכולים לשלוט בדפדפן האינטרנט או להחליף אותו.


#### תכנון מערכת לא מאובטח: אימות קלט JavaScript/WASM בצד הלקוח

תכנון לא מאובטח קשור ונפוץ הוא המקום שבו קוד נשלח לדפדפני אינטרנט, לדוגמה, כ- JavaScript או WebAssembly (WASM), וקוד זה מבצע בדיקות אבטחה לפני שליחת הנתונים שלו לשרת. ברוב המצבים, תוקפים יכולים לשלוט בדפדפן האינטרנט, בזמן שהשרת נמצא בשליטתך, כך ששוב, לא ניתן לסמוך על שום דבר שדפדפן האינטרנט עושה. במילים אחרות, כל בדיקות אבטחה בקוד שנשלח לדפדפן יכולות להיעקף באופן טריוויאלי על ידי תוקפים, שכן התוקפים שולטים בדפדפני האינטרנט שלהם. בעיה קשורה היא מתן גישה ישירה למסד נתונים למשתמשים לא מהימנים. לעתים קרובות משתמשים אינם זקוקים לגישה מלאה, ולכן זה נותן למשתמשים הרבה יותר הרשאות ממה שהם צריכים (תוך הפרת ההרשאה הפחותה), וגישה כזו יכולה להקשות על מניעת עקיפת בדיקות אבטחה. האיור הבא מציג טעות זו:


![עיצוב לא מאובטח: באיור זה בדיקות אימות קלט רלוונטיות לאבטחה מופעלות בדפדפן אינטרנט, ולא מופעלות שוב על-ידי שרת האינטרנט. מכיוון שהתוקפים יכולים לשלוט בדפדפן האינטרנט שלהם, הדבר אינו מאובטח. מסד הנתונים נגיש ישירות גם למשתמשים מחוברים; זה סימן רע, כי זה נותן הרבה גישה לנתונים כי הוא לעתים קרובות מיותר.](/insecure_design.png)

יישום JavaScript לא מאובטח

#### תכנון מערכת מאובטח: אימות קלט בסביבה שניתן לסמוך עליה

ניתן להשתמש ב- JavaScript בצורה מאובטחת, אנחנו רק צריכים לעשות את זה נכון. אנו יכולים לשלוח JavaScript ללקוח, ואנו יכול לעשות כמה בדיקות רלוונטיות לאבטחה בדפדפן (למשל, כדי לתת משוב מהיר). אבל אם התוקפים יכולים לשלוט בדפדפני אינטרנט מסוימים (אך לא בשרתים), בדיקות האבטחה בצד הדפדפן אינן רלוונטיות לאבטחה. במקרה נפוץ זה, עלינו לבצע את כל בדיקות הקלט הקשורות לאבטחה בשרתים, גם אם חלק מהבדיקות היו אמורות להיעשות בצד הלקוח וכעת הן "מבוצעות מחדש". בדיקות הקלט (אימותים) אינן באמת מבוצעות מחדש, מכיוון שלא ניתן היה לסמוך על אלה בצד הלקוח.

האיור הבא מציג עיצוב דומה אך מאובטח; שימו לב שכל הבדיקות הקשורות לאבטחה נעשות בשרת, שכן במקרה זה, זו המערכת שאנו יכולים לסמוך עליה. היא גם מונעת גישה ישירה למסד נתונים, וזה לעתים קרובות רעיון טוב אם משתמשים אינם זקוקים לגישה ישירה:


![חלופה מאובטחת יותר של יישום JavaScript: באיור זה כמה בדיקות אימות קלט רלוונטיות לאבטחה מופעלות בדפדפן אינטרנט, אך כל בדיקות האבטחה מופעלות על-ידי שרת האינטרנט, גם אם חלקן הופעלו בדפדפן קודם לכן. מכיוון שהשרת במקרה זה מהימן, זהו ,תכנון מאובטח. מסד הנתונים אינו נגיש ישירות למשתמשים מחוברים; זוהי ארכיטקטורה טובה, כי גישה ישירה למסד הנתונים היא לעתים קרובות מיותרת.](/a_secure_design.png)

חלופה מאובטחת יותר של יישום JavaScript

#### תכנון מערכת לא מאובטח: יישום נייד עם בדיקה בצד הלקוח

תכנון מערכת לא מאובטח נפוץ דומה הוא קוד באפליקציות סלולריות לסמארטפון שעושה את כל בדיקות האבטחה לפני שליחת הנתונים שלו לשרת. שוב, איננו יכולים להניח כי בדיקות אבטחה כלשהן ביישום הנייד אכן יבוצעו. תוקפים יכולים לשנות את היישום הנייד, או לכתוב יישום אחר, כדי לעקוף את כל הבדיקות שבוצעו ביישום הנייד. אם אנו כותבים יישום נייד לסמארטפון, אנו גם בדרך כלל לא יכולים לסמוך על היישומים האחרים - היישומים האחרים עשויים בעצמם להיות זדוניים!


#### תכנון מערכת לא מאובטח: יישום לקוח בהתאם לשרת לא מהימן

אל תתבלבלו; הנקודה אינה *"שרת זה טוב, לקוח זה רע".* הבעיה היא שכמעט בכל המקרים, כל קוד שאנו צריך לסמוך עליו חייב לפעול בסביבה שאנו יכול לסמוך עליה.

אם אנו כותבים דפדפן אינטרנט, לדוגמה, נצטרך לסמוך על שירותי מערכת ההפעלה המקומיים, אך אנו בהחלט לא יכול לסמוך על שרתי אינטרנט מרוחקים ושרירותיים - חלק מאותם שרתי אינטרנט מרוחקים עלולים לשלוח לנו נתונים זדוניים!


#### כלל המפתח: נפעיל קוד שעלינו לתת בו אמון בסביבה שניתן לסמוך עליה

בקיצור: כל קוד שאנו צריכים לסמוך עליו חייב (ברוב המקרים) לפעול בסביבה שאנו יכולים לסמוך עליה, *לא* במערכת שעשויה להיות נשלטת על ידי תוקפים.

באפשרותנו להשתמש ב- JavaScript בצד הלקוח, ב- WebAssembly בצד הלקוח וביישומים ניידים - זו לא הבעיה. אנו יכולים לכתוב גם דפדפני אינטרנט! הבעיה היא מתן אמון במערכת שעשויה להיות תחת שליטתו של תוקף. אם יש לנו מערכת שרת-לקוח מבוססת אינטרנט, לדוגמה, בדרך כלל הקוד הפועל בשרת (שאנו שולטים בו) חייב לבצע את כל בדיקות האבטחה. אחרי הכל, תוקפים יכולים לבנות או לשנות אפליקציות לקוח משלהם, כולל JavaScript שנשלח ללקוח שלהם על ידי שרת. זה בסדר להריץ בדיקות על מערכת שאנו לא סומכים עליה באופן מלא אם אנו רוצה לספק תגובה מהירה לטעויות לא מכוונות. אבל זה לא מספיק - עבור אבטחה, כל בדיקות האבטחה צריך להיעשות (או  להיעשות מחדש) על מערכת שאנו יכולים לסמוך עליה באופן מלא. באפשרותנו להפעיל בדיקות אלה בצד השרת באמצעות JavaScript, WebAssembly או כל דבר אחר שבוטחים בו - אך עלינו להפעיל את הבדיקות במערכת שניתן לסמוך עליה.


מפתחים מסוימים מנסים להריץ קוד במערכות שהם לא יכולים לסמוך עליהן באמצעות ערפול (obfuscation). כלומר, הם ישתמשו בכלים שמנסים להקשות על הבנת הקוד שנשלח למערכת שהם לא יכולים לסמוך עליה. דוגמה לכך היא שימוש במיניפיקציה של JavaScript ובתקווה שזה יקשה על הבנת קוד הלקוח. אל תעשו את זה! המטרה של מיניפיקציה של JavaScript היא להפחית את מספר הבתים שנשלחים ברשת, לא להסתיר את מה שהקוד עושה או למנוע את שינויו.
...
זה הרבה יותר טוב להפעיל תוכנה שצריך לסמוך עליה, על מערכת שאפשר לסמוך עליה; אז התוכנה פשוט עובדת כל הזמן.


#### סימני אזהרה

בניית מערכת עם בדיקות אבטחתיות שניתן לעקוף היא טעות מסוכנת. לא רק שזה אומר שהמערכת אינה מאובטחת, אלא שלעתים קרובות קשה מאוד לתקן את הטעות הזו ברגע שאנו עושים אותה. ייתכן שיהיה עלינו לשכתב תוכנות רבות כדי לתקן טעות זו. הנה רשימה קצרה של דברים שיש לחפש שעשויים להצביע על טעויות מסוג זה:

* תבנית HTML או תבנית נתונים אחרת הנשלחת ללקוח המבצע אימות קלט רלוונטי לאבטחה במערכת שתוקף עשוי לשלוט בה. זה יכול להיות בסדר, אבל רק אם כל הבדיקות האלה מבוצעות מחדש בסביבה מהימנה.

* קוד JavaScript או קוד אחר שנשלח ללקוח שמבצע אימות קלט או פעולות רלוונטיות אחרות לאבטחה במערכת שהתוקפים עשויים לשלוט בה. זה יכול להיות בסדר, אבל רק אם כל הבדיקות האלה מבוצעות מחדש בסביבה מהימנה.

* אפליקציה למכשירים ניידים שמבצעת אימות קלט רלוונטי לאבטחה. זוהי אותה בעיה בצד הלקוח.

* מסד נתונים הנגיש ישירות דרך הרשת לשימוש על ידי יישום לקוח (דפדפן אינטרנט, אפליקציה לנייד וכו'). פעולה זו יכולה להיות מאובטחת, אך עלינו לוודא שכל הפעולות שהמשתמש רשאי לבצע מאושרות. במערכות רבות, אנו יכולים לשלוט על זה עם הפקודה SQL GRANT, אם אנו צריכים לעשות את זה. עם זאת, לעתים קרובות עדיף (או הכרחי) לתווך גישה באמצעות תוכנית במקום לספק גישה ישירה למסד נתונים. גישה ישירה למסד נתונים עלולה להקשות על ביצוע אימות קלט. לעתים קרובות זה מפר את ההרשאות הפחותות, שכן לעתים קרובות המשתמש אינו זקוק לגישה מלאה למסד הנתונים. אם אנו מספקים גישה ישירה למסד נתונים, נשקול להגביל את ההרשאות. לדוגמה, ייתכן שנעניק גישה רק לתצוגה לקריאה בלבד במקום למסד הנתונים כולו.

* ערוץ תקשורת רשת שתוקפים יכולים להשתלט עליהם. חיבורי רשת המיושמים כראוי המשתמשים ב- TLS (כגון **https:**) ו- SSH מתנגדים להשתלטות; כמעט כל השאר לא. תוכנה עשויה לתקשר דרך הערוץ בהנחה שהיא מדברת עם אותו משתמש/תוכנה, אך ניתן לעקוף זאת בקלות אם ניתן להשתלט על הערוץ.

#### ניסיון להפעיל תוכנה שאתה חייב לסמוך עליה בסביבות לא אמינות

*האם* אנו יכולים לנסות להפעיל תוכנה שאנו צריך לסמוך עליה במערכת שאנו לא סומכים עליה? נוכל לנסות, אבל זה בדרך כלל זה לא עובד טוב, וניסיון לעשות את זה הוא נושא מתקדם מאוד. הנה כמה מהטכניקות שנוסו:

* טכניקה אחת היא הצפנה הומומורפית. זה מאפשר לנו להפעיל קוד בזמן שהנתונים   נשארים מוצפנים. אבל כיום הצפנה הומומורפית היא מעשית רק בנסיבות מיוחדות. זה איטי בכמה סדרי גודל ומורכב הרבה יותר.

* מנגנוני ה-Software Guard eXtensions (SGX) של אינטל אמורים לאפשר ביצוע ואחסון נתונים, אך בפועל הם נשברו שוב ושוב ([*ביזה של מפתחות קריפטו מ-SGX מאובטח במיוחד שולחת את אינטל לסחרור נוסף,*](https://arstechnica.com/information-technology/2020/06/new-exploits-plunder-crypto-keys-and-more-from-intels-ultrasecure-sgx/)מאת דן גודין, 2020).

* אם אנו מנסים לאבטח משחקים במחשב נייד / שולחני, ואנו לא סומכים על המחשב הנייד / השולחני, יש מערכות נגד רמאויות. אבל מערכות נגד רמאויות נשברות באופן שגרתי. עדיף לנו לקיים אירועים פיזיים שבהם כל המחשבים הניידים / המחשבים השולחניים נמצאים בבעלותנו.


באופן כללי, עדיף לנו להשתמש בפתרונות פשוטים שאינם כרוכים בניסיון לסמוך על מערכות הנשלטות על ידי תוקפים.

#### חידון 2.4: גישור הרשאות מלא (אי עקיפה)

\>\>שרת שולח קוד JavaScript מבוסס React לדפדפן אינטרנט. מפתחים רוצים לכלול כמה בדיקות אבטחה של הקלט בקוד React בצד הלקוח (בצד הדפדפן), ואומרים שהשרת יכול לתת אמון בבדיקות אבטחה אלה מכיוון שהשרת שלח את קוד ה- React בצד הלקוח מלכתחילה. איזה מהמשפטים הבאים נכון?<<
...
לשרת אין אפשרות לבדוק בדיקות אבטחה בצד הלקוח באופן כללי, כולל במקרה זה. השרת עשוי לשלוח קוד JavaScript מבוסס React לדפדפן אינטרנט, אך *התוקפים* שולטים בדפדפן האינטרנט. משמעות הדבר היא שהתוקפים יכולים לשנות את הקוד המופעל לאחר קבלתו, או פשוט לשנות את התשובות שהקוד ישלח בחזרה לשרת. שימו לב שזה לא ספציפי ל- React, זה יהיה נכון עבור *כל* קוד בצד הלקוח... אנחנו פשוט משתמשים ב-React כדוגמה נפוצה.  מערכת בדרך כלל אינה יכולה לתת אמון במערכת אחרת הנמצאת תחת שליטה פוטנציאלית של תוקף.

[הסבר]

### שאר עקרונות תכנון המערכת של זלצר ושרודר

הבה נבחן בקצרה את שאר עקרונות התכנון המאובטח שזוהו על ידי זלצר ושרודר (מעבר להרשאות הפחותות ולגישור ההרשאות המלא):

1. **מנגנון חסכוני (גם פשטות)**. המערכת, בפרט החלק שהאבטחה תלויה בו, צריכה להיות פשוטה וקטנה ככל האפשר. זה הופך את החלק הזה של המערכת לקל יותר לבדיקה וקשה יותר לטעות בו. כמובן, תוכנה מודרנית מתבקשת לעתים קרובות לספק הרבה פונקציונליות, אז אנו בדרך כלל לא יכולים לעשות הכל פשוט מאוד, אבל אנו יכולים לפחות לעבוד כדי להפוך את החלק שהאבטחה תלויה בו לפשוט ככל האפשר.


2. **תכנון פתוח**. אסור שמנגנון ההגנה יהיה תלוי בבורות של התוקפים. במקום זאת, המנגנון צריך להיות ציבורי, בהתאם לסודיות של פריטים מעטים יחסית (וניתנים לשינוי בקלות) כמו סיסמאות או מפתחות פרטיים. תכנון פתוח מאפשר ביקורת ציבורית נרחבת. תכנון פתוח גם מאפשר למשתמשים לשכנע את עצמם שהמערכת שעומדת לשימוש מספקת. למען האמת, זה לא מציאותי לנסות לשמור על סודיות עבור מערכת שמופצת באופן נרחב; decompilers וחומרת פריצה יכולים לחשוף במהירות "סודות" במימוש. אחד היתרונות הגדולים של תוכנת קוד פתוח (OSS) הוא שהיא מיישמת טוב יותר את עקרון העיצוב הפתוח; לקוד המקור של OSS יש עיצוב פתוח, המאפשר לכל אחד אחר לסקור אותו ולבצע שינויים כדי לשפר אותו. כמובן, OSS צריך *למעשה* להיסקר עבור זה כדי לעזור, אבל זה  יתרון *פוטנציאלי* חשוב  .


3. **ברירות מחדל מאובטחות (הידועות גם כברירות מחדל אל-כשל)**. התקנת ברירת המחדל צריכה להיות ההתקנה המאובטחת. אם לא בטוח שצריך לאפשר משהו, לא נאפשר אותו. לדוגמה, לא נפיץ תוכנה עם סיסמה ריקה או סיסמת ברירת מחדל; במקום זאת, *נדרוש* להגדיר סיסמה חדשה בעת התקנת התוכנה. בדרך זו, אם מישהו רק מתקין אותה במהירות, לא תהיה לו פגיעות עקב סיסמה ידועה. נודא שהרשאות ברירת המחדל מאובטחות; קטגוריית חולשה [CWE-276](https://cwe.mitre.org/data/definitions/276.html) היא "הרשאות ברירת מחדל שגויות".
...
5. **המנגנון הכי פחות נפוץ (גם למזער שיתוף).** נצמצם את הכמות והשימוש במנגנונים משותפים אם למשתפים יש הרשאות שונות. נמנע משיתוף קבצים, ספריות, ביצוע בקרנל של מערכת הפעלה או מחשבים עם משהו שאנחנו בוטחים בו, מכיוון שהתוקפים עלולים לנצל אותם. כמובן, במקרים רבים זה בא על חשבון גורמים אחרים. דוגמה ברורה היא שירותי ענן: במקרים מסוימים, שימוש בשירות ענן עלול לגרום לתוכנית שלך לפעול בסביבה משותפת עם יריב. במקרה של שירותי ענן, לעתים קרובות ישנם גורמים מקלים שהופכים אותם למקובלים (לדוגמה, ספק שירותי הענן עשוי לספק שורה של אמצעים כדי לספק בידוד טוב יותר, ו/או עשוי להיות צוות מנוסה יותר שמגן ומנטר את המערכות טוב יותר מאשר שאנו יכולים). עם זאת, זה עדיין נכון שכל דבר שאנו משתפים עם תוקפים עלול להוסיף דרך נוספת שבה הוא יותקף. אם שיתוף כזה מסוכן מדי עבור היישום שלך, ניתן לבחור חלופות עם פחות שיתוף (כגון ענן של לקוח יחיד או ענן פרטי). במקרים מסוימים שיתוף יכול להפחית עלויות אך להגביר את סיכוני האבטחה. ההחלטה הטובה ביותר תלויה בנסיבות, וכל מה שעקרונות העיצוב יכולים לעשות הוא לעזור לנו לזהות את הפשרה.


6. **קבילות פסיכולוגית (גם קלות לשימוש)**. הממשק האנושי חייב להיות מתוכנן כך שיהיה קל לשימוש כך שהמשתמשים ישתמשו באופן שגרתי ואוטומטי במנגנוני ההגנה בצורה נכונה. טעויות יצטמצמו אם מנגנוני האבטחה יתאימו באופן הדוק לדימוי המחשבתי של המשתמשים לגבי מטרות ההגנה שלהם. יש אנשים שחושבים שתמיד יש פשרה בין אבטחה לקלות שימוש, אבל זה לעתים קרובות לא נכון; אם משהו קשה לשימוש, הוא לעתים קרובות חסר ביטחון בפועל (כי אנשים יעבדו סביב זה). קלות שימוש לא טובה מטעמי אבטחה מראה בדרך כלל שהתוכנה לא תוכננה להיות מאובטחת מלכתחילה; אני מקווה שהקורס הזה יעזור לך להימנע מכך!

## חידון 2.5

\>\>איזה מהבאים הוא עיקרון אבטחה מקובל?|| סמנו את כל האפשרויות שלהלן שהן עקרונות אבטחה מקובלים, ואל תסמנו אותן אחרת.<<

[!] הפיכת קוד המקור לקשה להבנה (למשל, שימוש בשמות מעורפלים) כך שיהיה קשה יותר לזהות פגיעויות. {{ נבחר: לא, אם קוד המקור קשה יותר להבנה, אז יהיה קשה יותר למפתחות להפוך אותו למאובטח מלכתחילה. צריך לשאוף לשמור על המערכת פשוטה ככל האפשר. }}


[ ] וידוא כי התכנון של מנגנון האבטחה הוא סודי, כך שיהיה קשה יותר לגלות בעיות בו. {{ נבחר: לא, עיקרון ידוע מכבר הוא "תכנון פתוח" - המערכת חייבת להיות מאובטחת גם אם התכנון של מנגנון האבטחה הוא ציבורי. במוקדם או במאוחר התכנון שלה יתגלה, ואנו לא יכולים לדעת מתי זה קרה. עדיף להבטיח שהוא יהיה מאובטח גם אם ידוע איך הוא עובד. }}

[x] התוכנה צריכה להיות מאובטחת כברירת מחדל.

[x] תמיכה באימות דו-שלבי, כך שגם אם לתוקפים יש ערך אימות יחיד (כגון סיסמה), התוקפים לא יוכלו לנצל אותו.

[x] צמצום שיתוף הרכיבים בין בעלי הרשאות שונות. דוגמאות לרכיבים הן ספריות וקונטיינרים.

[x] הפיכת התוכנה לקלה לשימוש, בפרט, ננסה להבטיח שהמשתמשים ישתמשו באופן שגרתי ואוטומטי במנגנוני ההגנה כראוי.

### עקרונות תכנון מערכת אחרים

עקרונות תכנון רבים אחרים הוצעו, בהתבסס על בעיות שקרו למערכות קודמות. כעת, נסתכל על כמה עקרונות תכנון אחרים שאנו צריכים לשקול.


#### היזהרו ממרוץ תהליכים (Race condition)

 *מרוץ תהליכים* מתרחש כאשר ההתנהגות הנכונה של מערכת תלויה ברצף האירועים, אך אין שליטה על רצף זה. מרוצי תהליכים כוללים בדרך כלל תהליך אחד או יותר או ת'רדים (Threads) שניגשים למשאב משותף, אך גישה מרובה זו לא נשלטה כראוי.
...
אם אין שליטה בכלל, זהו פגם, וזו יכולה להיות אפילו פגיעות. תוכניות רבות, כדי להיות מאובטחות, צריכות לעשות שני דברים: (1) לקבוע אם בקשה מורשית, ו-(2) אם כן, לפעול על פי בקשה זו. אם התוקפים יכולים לשנות את המצב בין שלבים 1 ל -2, התוכנית יכולה לקבוע נכונה שהיא מורשית, אך לאחר מכן לאפשר פעולה אחרת ש*לא* אושרה . סוג זה של טעות אבטחה הוא כל כך נפוץ שיש לו שם - מרוץ תהליכים מסוג *זמן הבדיקה - זמן השימוש* (TOCTOU).

במצבים רבים, הדרך הנכונה להתמודד עם מרוץ התהליכים של TOCTOU היא ליישם ולהשתמש בממשקי API שגם בודקים את ההרשאה וגם מבצעים את הפעולה *בו זמנית* (כלומר, הם לא יאפשרו לתוקפים לשנות את המצב בין הבדיקה לבין השימוש). לדוגמה:

1. בעת יצירת קבצים או כל דבר אחר בעל הרשאות המשויכות אליו, לא ניצור אותם ולאחר מכן נסה לצמצם את ההרשאות שלהם. במקום זאת, ניצור אותם עם הרשאות מינימליות מאוד ונרחיב אותם לפי הצורך. בדרך זו, אין חלון זמן שבו תוקפים עשויים להיות מסוגלים לנצל את ההרשאות העודפות.

2. אם אנו כותבים תוכנית עבור מערכת דמוית יוניקס, לא נקרא ל - **()access** כדי **לראות אם ניתן לפתוח קובץ, ולאחר מכן נקרא ל **()open*** כדי לפתוח את הקובץ בפועל. במקום זאת, נגדיר את הדברים כך שפשוט נקרא ל **()open** ישירות, מכיוון    ש **()open** כולל בדיקה הבודקת אם הגישה מותרת.

3. אם ברצוננו להבטיח שניצור קובץ חדש במערכת דמוית יוניקס, נקפיד לבקש שהוא ייווצר *באופן בלעדי (**O_EXCL** ב- API **()open** של C , והאות **x** ב-  **fopen()** והפלאגים (flags) המשמשים בשפות תכנות רבות אחרות). שוב, בדרך זו אין חלון הזדמנויות לתוקפים ליצור את הקובץ לפני שהתוכנית יכולה (אם התוקפים יכולים לעשות זאת).

שגיאה נפוצה במקצת במערכות דמויות יוניקס היא יצירת קבצים זמניים בצורה לא מאובטחת. ניתן ליצור קבצים באופן זמני בספריה שבה תוקפים יכולים להשפיע על היצירה והשמות של קבצים אחרים. אם תוקפים יוצרים תחילה קובץ, ולאחר מכן היישום מבקש "ליצור" קובץ מבלי לבקש שהוא יהיה בלעדי, נעשה שימוש חוזר בקובץ הקיים הנשלט על-ידי התוקף. שימוש פשוט באפשרות הבלעדית אינו מספיק, שכן זה עדיין יאפשר מניעת שירות. הפתרון הוא להשתמש בלולאה פשוטה שיוצרת שם קובץ "אקראי" בספרייה המיועדת ולאחר מכן לנסות ליצור אך ורק עם הרשאות מוגבלות מקסימלית.

לרוב השפות יש פונקציה או פקודה ליצור קבצים זמניים באופן מאובטח; השתמשו בהם היכן שהם זמינים. ב- Python מודול tempfile יכול ליצור קבצים זמניים באופן מאובטח. סקריפטים של Shell יכולים להשתמש בפקודה mktemp כדי ליצור קבצים זמניים באופן מאובטח.



 מירוץ תהליכים היא סיבה כה נפוצה לפגיעויות אבטחה שהיא מדורגת במקום ה- 33 ב25 הגדולות של CWE 2019 2021 CWE ובמקום ה 29 ב 25 הגדולות של.  *ביצוע מקבילי באמצעות משאב משותף עם סינכרון לא תקין ('מירוץ תהליכים')* הוא [CWE-362](https://cwe.mitre.org/data/definitions/362.html). *קובץ זמני לא מאובטח* הוא [CWE-377](https://cwe.mitre.org/data/definitions/377.html).

#### הקשחת המערכת

פגמים קורים! אבל הם לא צריכים להפוך לפגיעויות. במקום זאת, ננסה לתכנן את המערכת שלנו כך שיהיה הרבה פחות סביר שפגם בודד יגרום לסכנה מוחלטת. זהו בעצם יישום ספציפי של עקרון ההרשאות הפחותות, אך אם אנו חושבים באופן ספציפי על הפיכת המערכת לקשה לערעור *גם* כאשר יש בה פגם, אנו עשויים לזהות צעדים אחרים שניתן לנקוט.


ישנם מנגנונים רבים שיכולים להקשיח מערכת. דוגמאות כוללות Content Security Policy (CSP) ו - Address Space Layout Randomization (ASLR). נדון בכמה מנגנוני הקשחה בהמשך הקורס. הנקודה כאן היא שאנו צריכים להפעיל מנגנוני הקשחה או להבטיח שהמשתמשים שלנו יוכלו להפעיל אותם.

#### שמור סודות בסוד

אם התוכנה שלנו מנהלת סודות כמו מפתחות הצפנה פרטיים וסיסמאות, נודא שהם נשארים סודיים. בפרט:

* לא נכניס סודות תקפים לקוד המקור שלנו. קוד המקור מנוהל על ידי מערכות בקרת גרסאות ולעתים קרובות מתפשט ליותר אנשים ומערכות ממה שאנו חושבים.

* נאחסן סיסמאות המשמשות לאימות כניסה באמצעות אלגוריתם שתוכנן במיוחד לעשות זאת. נדון בהם בהמשך הקורס, אך אלגוריתמים מסוג זה נקראים  אלגוריתמי *salted hash לכל משתמש* (כגון argon2id, bcrypt או PBKDF2). אם הדבר נעשה כהלכה, אין זה אפשרי עבור תוקפים להשיג סיסמאות רבות גם אם התוקפים מקבל את נתוני הסיסמה המוצפנים.

* נשתמש ב **https://** במקום ב- **http://**; המספק קישור מוצפן כדי למנוע דליפת נתונים.

* נמנע מקבלת ושליחת נתונים סודיים (כמו מפתחות פרטיים) כפרמטרים של שורת הפקודה, היכן שאנו יכולים; פרמטרים של שורת הפקודה גלויים לעתים קרובות לתהליכים אחרים במערכת.

#### סמוך על ערוצים מהימנים בלבד

באופן כללי, סמכו רק על מידע (קלט או תוצאות) מערוצים מהימנים. לדוגמה, השתמשו ב-  **https://** במקום ב- **http://** בעת יצירת קשר עם שרת, מכיוון שזה מאפשר לבדוק אם לשרת יש אישור הצפנה חוקי עבור אתר זה. באופן כללי עלינו להשתמש ב- **https**, מכיוון שזה ימנע מהתוקפים לחטט או לשנות מידע שהוחלף עם משתמשים אחרים.

#### הפרדת נתונים מ'פעולות'

טריק שימושי לפיתוח תוכנה מאובטחת יותר הוא להפריד נתונים מפעולות (גם תוכניות). במילים אחרות, עלינו להפריד את הנתונים הפסיביים מהתוכניות המבוצעות. בדרך זו, אם תוקפים מצליחים להדליף מידע "נוסף" לנתונים, הדבר לא יגרום להפעלת תוכנית זדונית פוטנציאלית. זוהי בעצם דרך נוספת ליישם את ההרשאה הפחותה ביותר - אל תיתנו לנתונים את הזכות לפעול כתוכנית.

דוגמה טובה לכך היא מדיניות אבטחת התוכן (CSP) הנתמכת על ידי דפדפני אינטרנט מודרניים. CSP מאפשר לך לציין שה- HTML שנשלח הוא 'נתונים' בלבד, *ואינו* מורשה לספק סקריפטים מוטבעים (תוכניות) או עיצובים (שיכולים להיות גם תוכניות) - במקום זאת, ניתן להוריד את הסקריפטים והעיצובים רק ממקומות מהימנים שצוינו. באופן זה, אם תוקפים מצליחים לחתור תחת ה- HTML, התוקפים לא יוכלו לגרום להפעלת תוכניות המסופקות על-ידי התוקפים.

 תכנון לא מאובטח הוא טעות כל כך נפוצה ביישומי אינטרנט שהוא דורג במקום 4 ב 2021 OWASP Top 10.

#### חידון 2.6: עקרונות תכנון מערכת אחרים

\>\>איזה מהבאים הוא עיקרון אבטחה נוסף שימושי?|| סמנו את כל האפשרויות שלהלן שהן עקרונות אבטחה מקובלים, ואל תסמנו אותן אחרת.<<

ס[!x]תכננו ויישמו את המערכת כדי להבטיח שלאחר אישור הבקשה, תוקפים אינם יכולים לשנות משהו רלוונטי להחלטה זו לפני שהבקשה מטופלת. {{ לא נבחר: זה חשוב, זה נקרא זמן הבדיקה - זמן השימוש (TOCTOU). }}

[x] שנו את תכנון והגדרת המערכת כך שהסבירות לחולשה נמוכה יותר *גם* אם יש פגם. {{ לא נבחר: נכון, זה נקרא "הקשחת" מערכת. }}

[ ] הציבו סיסמאות ומפתחות סודיים בקוד המקור, כך שהמערכת תוכל לקבל מידע זה ולהשתמש בו במהירות מבלי להיות תלויה ברכיבים חיצוניים או במאגרי נתונים. {{ נבחר: לא, בבקשה *אל* תעשו את זה. סיסמאות ומפתחות סודיים לא צריכים להיות בקוד מקור. אם הם לא מופיעים בקוד המקור, אנשים שיכולים לראות את קוד המקור לא יקבלו את המידע הסודי, והשארתם מחוץ לקוד המקור גם מקלה על שינוי הסיסמאות והמפתחות. }}

[ ] כללו פעולות (כולל תוכניות) עם נתונים, כך שתפעול הנתונים מסופק בקלות עם הקוד. {{ נבחר: זה יכול להיות שימושי, אבל זה גם מסוכן מבחינה אבטחתית. אם תוקפים מצליחים להחדיר מידע "נוסף" לנתונים, תכנון זה יכול להקל על הפעלת תוכנית שעלולה להיות זדונית. לפעמים חשוב לעשות זאת בכל מקרה, אבל זה יוצר סיבוכים נוספים בעת פיתוח תוכנה מאובטחת. }}
...
9. **מהי ההערכה שלך לגבי הקו?**  אפילו סקירה קצרה של קוד המקור של התוכנה, והשינויים שלה לאורך זמן, יכולה לתת לך כמה תובנות. להלן דברים שיש לקחת בחשבון:
    ...
    5. שיקלו להפעיל את התוכנה בתוך סאנדבוקס (Sandbox) כדי לנסות להפעיל ולזהות קוד זדוני.
