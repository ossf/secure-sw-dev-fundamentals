...
* אם התוכנית שלך מקבלת סיסמה, אל תהדהד את התווים המדויקים בחזרה; פעולה זו יוצרת דרך נוספת שבה סיסמאות יכולות להיראות על-ידי אחרים. בטופסי HTML, הגדר את סוג הקלט לסיסמה, המגבילה במכוון את המשוב.
...
* באופן כללי, אל תציג נתונים רגישים/פרטיים אלא אם כן הדבר נחוץ בשלב זה.
