...
All of life involves risk. It is unrealistic to expect that there will be no risks in life. In particular, there are risks to anyone using software because it may have vulnerabilities. Software developers make mistakes, and some of those mistakes might lead to security vulnerabilities. Someone may even try to intentionally insert vulnerabilities or malicious code into your software, or the software you depend on, during its development. Even very strong techniques for countering vulnerabilities must build on assumptions or can only eliminate *some* security-related risks. Again, it is unrealistic to expect there to be no risks.
...
Do *not* wait to think about risks until they happen. Then, they are no longer risks; they are *problems*. It is easier and cheaper to address risks *before* they become problems! It is easier to design the software to minimize risks than to change the software later. It is also more convenient for the user, and better for the developer's, product's, and brand's reputation.
