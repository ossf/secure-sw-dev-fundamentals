...
1. **Quizzes**. We ask quiz questions along the way to help reinforce concepts. It is easy to disengage with traditional books and videos, thinking that you understand the core concepts even when you do not. In contrast, the quizzes help reinforce the core concepts so you will understand them.

2. **Free**. If you just want to learn, it does not cost anything! All you need is an internet connection. Many people have limited resources and we want to make sure this information is available to them.
...
6. **Applicable to Open Source Software (OSS)**. Many materials on security do not spend significant time on OSS, or are difficult to apply when developing OSS. Yet OSS is key to modern software development. We include information specifically for those developing and/or using OSS.
